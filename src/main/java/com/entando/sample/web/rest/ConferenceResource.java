...
import com.entando.sample.repository.ConferenceRepository;
...
/**
 * REST controller for managing {@link com.entando.sample.domain.Conference}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ConferenceResource {
    ...
    private static final String ENTITY_NAME = "ciConference";
